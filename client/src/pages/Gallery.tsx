...
export default function Gallery() {
  ...
  const extendedGalleryItems = [
    ...
    {
      id: '4',
      title: t('gallery.items.sportsComplex.title'),
      description: t('gallery.items.sportsComplex.description'),
      image: '/images/Classroom1.jpg',
      category: 'campus' as const,
    },
    {
      id: '5',
      title: t('gallery.items.culturalPerformance.title'),
      description: t('gallery.items.culturalPerformance.description'),
      image: '/images/Culture2.jpg',
      category: 'cultural' as const,
    },
    {
      id: '6',
      title: t('gallery.items.hostelFacilities.title'),
      description: t('gallery.items.hostelFacilities.description'),
      image: '/images/Classroom3.jpg',
      category: 'campus' as const,
    },
    {
      id: '7',
      title: t('gallery.items.scienceExhibition.title'),
      description: t('gallery.items.scienceExhibition.description'),
      image: '/images/photo-1581833971358-2c8b550f87b3?ixlib=rb-4.0.3&auto=format&fit=crop&w=600&h=400',
      category: 'activities' as const,
    },
    {
      id: '8',
      title: t('gallery.items.annualSportsMeet.title'),
      description: t('gallery.items.annualSportsMeet.description'),
      image: '/images/photo-1544717297-fa95b6ee9643?ixlib=rb-4.0.3&auto=format&fit=crop&w=600&h=400',
      category: 'sports' as const,
    },
    {
      id: '9',
      title: t('gallery.items.independenceDayCelebration.title'),
      description: t('gallery.items.independenceDayCelebration.description'),
      image: '/images/photo-1578662996442-48f60103fc96?ixlib=rb-4.0.3&auto=format&fit=crop&w=600&h=400',
      category: 'events' as const,
    },
    {
      id: '10',
      title: t('gallery.items.computerLaboratory.title'),
      description: t('gallery.items.computerLaboratory.description'),
