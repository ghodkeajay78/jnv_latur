...
export default function Resources() {
  ...
  const downloads = [
    {
      title: t('resources.downloads.schoolProspectus202425.title'),
      description: t('resources.downloads.schoolProspectus202425.description'),
      fileType: 'PDF',
      fileSize: '2.5 MB',
      category: t('resources.categories.admissions'),
    },
    {
      title: t('resources.downloads.academicCalendar202425.title'),
      description: t('resources.downloads.academicCalendar202425.description'),
      fileType: 'PDF',
      fileSize: '1.2 MB',
      category: t('resources.categories.academic'),
    },
    {
      title: t('resources.downloads.feeStructure.title'),
      description: t('resources.downloads.feeStructure.description'),
      fileType: 'PDF',
      fileSize: '800 KB',
      category: t('resources.categories.admissions'),
    },
    {
      title: t('resources.downloads.admissionApplicationForm.title'),
      description: t('resources.downloads.admissionApplicationForm.description'),
      fileType: 'PDF',
      fileSize: '1.1 MB',
      category: t('resources.categories.admissions'),
    },
    {
      title: t('resources.downloads.syllabusClassVIToVIII.title'),
      description: t('resources.downloads.syllabusClassVIToVIII.description'),
      fileType: 'PDF',
      fileSize: '3.2 MB',
      category: t('resources.categories.academic'),
    },
    {
      title: t('resources.downloads.syllabusClassVToX.title'),
