...
export default function News() {
  ...
  const extendedNews = [
    ...
    {
      id: '4',
      title: t('news.items.interHouseSportsCompetition2024.title'),
      description: t('news.items.interHouseSportsCompetition2024.description'),
      date: '2024-01-12',
      type: 'event' as const,
      category: t('news.categories.sports'),
    },
    {
      id: '5',
      title: t('news.items.digitalLibraryInauguration.title'),
      description: t('news.items.digitalLibraryInauguration.description'),
      date: '2024-01-15',
      type: 'news' as const,
      category: t('news.categories.infrastructure'),
    },
    {
      id: '6',
      title: t('news.items.nationalScienceDayCelebration.title'),
      description: t('news.items.nationalScienceDayCelebration.description'),
      date: '2024-02-28',
      type: 'event' as const,
      category: t('news.categories.academic'),
    },
    {
      id: '7',
      title: t('news.items.studentExchangeProgram.title'),
      description: t('news.items.studentExchangeProgram.description'),
      date: '2024-01-20',
    ...
    {
      id: '8',
      title: t('news.items.annualDayPreparation.title'),
      description: t('news.items.annualDayPreparation.description'),
      date: '2024-02-15',
      type: 'event' as const,
      category: t('news.categories.cultural'),
    },
    {
      id: '9',
