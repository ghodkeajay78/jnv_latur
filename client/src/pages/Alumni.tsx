  ...
  const notableAlumni = [
    {
      ...
      batch: '1995',
      profession: t('alumni.professions.medicalDoctorResearcher'),
      achievement: t('alumni.achievements.leadingCardiologistAIIMS'),
      currentLocation: t('alumni.locations.newDelhi'),
    ...
    },
    {
      ...
      name: 'Ms. Sneha Patil',
      batch: '2001',
      profession: t('alumni.professions.iasOfficer'),
      achievement: t('alumni.achievements.districtCollectorPune'),
      currentLocation: t('alumni.locations.puneMaharashtra'),
    ...
    },
    {
      ...
      batch: '1998',
      profession: t('alumni.professions.softwareEngineer'),
      achievement: t('alumni.achievements.seniorDirectorMicrosoft'),
      currentLocation: t('alumni.locations.seattleUSA'),
    ...
    },
    {
      ...
      batch: '2000',
      profession: t('alumni.professions.researchScientist'),
      achievement: t('alumni.achievements.nasaSpaceResearch'),
      currentLocation: t('alumni.locations.houstonUSA'),
