...
export const newsItems: NewsItem[] = staticData.newsItems;

export const achievements: Achievement[] = staticData.achievements;

export const facultyMembers: FacultyMember[] = staticData.facultyMembers;
